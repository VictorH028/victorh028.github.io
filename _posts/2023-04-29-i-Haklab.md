...
Como tal solo hare breve receñas de la configuracion que se va a tener disponible.
...
En nuestra configuracion contamos con un total de `13` plugins los cuales explicare en breve.
...
Mostrar las asignaciones: `leader + g?`
...
#### LSP
 ...
 Estas son las combinaciones de teclas que `lsp-zero` habilita de forma predeterminada. Están destinados a seguir el valor predeterminado de Neovim.
 
- `<Ctrl-y>`: Confirma la selección.

- `<Ctrl-e>`: Cancelar la finalización.

- `<Down>`: navegue al siguiente elemento de la lista.

- `<Up>`: navega al elemento anterior de la lista.

- `<Ctrl-n>`: Vaya al siguiente elemento del menú de finalización o active el menú de finalización.

-  `<Ctrl-p>`: Vaya al elemento anterior del menú de finalización o active el menú de finalizació.
