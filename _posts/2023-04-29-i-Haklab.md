...
Puedes  definir tu color principal favorito si no te gusta el proporcionado. 
...
n la primera captura de pantalla:
...
mux_power_prefix_highlight_pos 'R'
Los íconos
```
